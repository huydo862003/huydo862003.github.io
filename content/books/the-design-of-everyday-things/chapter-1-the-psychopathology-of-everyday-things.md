...
concepts:
  ...
  - mental-model
  - system-image
parent: the-design-of-everyday-things
children: []
---
...
- Case Study: The "Trapped" friend
    ...
    > 
    - The root cause: Mechanics vs. Visibility
        
        The user was not actually locked in; they were simply fighting physics.
...
4. **Mappings**
5. **Feedback**
6. **Conceptual models** → Provides true understanding.
...
- **The hierarchy:** For designers, Signifier**s are more important than affordances**. An Affordance is useless if the user cannot perceive it; the signifier bridges that gap.
...
- Example: A Signifier that is both an Intentional signifier and an Accidental signifier.
    - A bookmark, a deliberately placed signifier of one's place
    in reading a book.
...
> **The scenario**: Why do people repeatedly push the elevator button or the pedestrian crossing button?
> 
> 
> **The missing link:** They lack feedback-a signal confirming that the system has received their request and is acting on it.
>
:::tip
**Feedback**
...
[Image of feedback loop control theory diagram](https://encrypted-tbn1.gstatic.com/licensed-image?q=tbn:ANd9GcTjhSzy7wCIDAJntpOa8Wc5H7CfgeAKqHiuy9wmTXy1KoR4tk2bfHRyOojejb-jO8hwBEA-BL0finfDPPUq3wzCWff3rlr5OPTgBvggHl_q-QgoS48)
...
- Example of multiple Conceptual models for the same product.
    ...
    People's conceptual models for the way that regenerative
...
> **Scenario**: A standard refrigerator with two controls: "Freezer" and "Refrigerator".
> 
> 
> **The user's goal**: Adjust the temperature of the freezer.
> 
...
1. **The designer:** Has the correct Conceptual model (Vertex 1).
2. **The product:** Isolated from the designer (Vertex 2).
3. **The user:** Forms their own model based solely on interacting with the product (Vertex 3).
