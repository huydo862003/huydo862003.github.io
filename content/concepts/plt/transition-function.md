...
description: "A Partial function from machine configurations (term, environment, stack, etc.) to successor configurations, defining each atomic step of execution until a final state is reached. In Lambda calculus w"
journey: plt
status: reviewing
