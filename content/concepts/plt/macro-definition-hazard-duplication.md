...
description: "A macro pitfall where an expression passed as argument is evaluated multiple times in the expansion, causing unintended repeated side-effects or performance issues."
journey: plt
status: reviewing
