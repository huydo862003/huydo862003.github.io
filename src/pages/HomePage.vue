      ...
      <div class="section">
        ...
        >
          ...
          >
            ...
            >
              <div class="item-row">
                <span class="item-link">{{ journey.title }}</span>
          ...
          >
            ...
            >
              <div class="project-header">
                <span
                  v-tooltip="{ content: project.repo, placement: 'bottom' }"
                  class="item-link"
                >
                  <GIcon
              ...
              >
                <a
                  v-if="project.npm"
                  v-tooltip="{ content: project.npm, placement: 'bottom' }"
                  :href="project.npm"
                  target="_blank"
                  rel="noopener"
                  class="plink"
                ...
                <a
                  v-if="project.docs"
                  v-tooltip="{ content: project.docs, placement: 'bottom' }"
                  :href="project.docs"
                  target="_blank"
                  rel="noopener"
                  class="plink"
              ...
              >
                <a
                  ...
                  :key="link.url"
                  v-tooltip="{ content: link.url, placement: 'bottom' }"
                  :href="link.url"
                  target="_blank"
                  rel="noopener"
                  class="plink"
